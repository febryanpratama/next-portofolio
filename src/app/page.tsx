  ...
  return (
    ...
    <>
      <section className="flex flex-col items-center gap-4">
        ...
        <div className="container flex justify-between px-4 py-5">
          <div className="text-3xl font-bold text-center">
            Febryan<span className={title({ color: 'violet' })}>.</span>{' '}
          </div>
          <div>
      ...
      <section className="flex flex-col items-center gap-4 p-10">
        <div className="container flex justify-between px-4 py-5">
          <div className={title({ size: 'small', color: 'foreground' })}>
            About Me
          </div>
      ...
      <section className="flex flex-col items-center gap-10 p-10">
        <div className="container">
          <div className={title({ size: 'sm', color: 'foreground' })}>
            ...
            experience with the past 2 years spent honing my skills in Laravel,
            And Webflow.
          </div>
          <div className="grid grid-cols-2 gap-2 mt-10 pb-10">
            ...
            >
              1 understand the importance of a Pixel- perfect Website, pride
      ...
      <section className="flex flex-col">
        <div className="w-full border-b-1 border-t-1 px-10 py-10 border-gray-500 grid grid-cols-3 justify-items-center items-center">
          <div className="flex flex-col">
            ...
            <div className="mt-2">Laravel</div>
          </div>
          <div className="flex flex-col">
            <div className={title({ size: 'small', color: 'violet' })}>
              Alatan Asasta Indonesia
            </div>
            <div className="mt-2">Laravel, ExpressJs</div>
          </div>
          <div className="flex flex-col">
            <div className={title({ size: 'small', color: 'violet' })}>
              Slog Polri
            </div>
            <div className="mt-2">Laravel, ExpressJs, NextJs</div>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col items-center p-10 border-b-1 border-foreground-600">
        <div className="container flex flex-col ">
          <div
            className={`${title({ size: 'small', color: 'foreground' })} text-center`}
          >
            Our Project
          </div>
          <div
            className={`${title({ size: 'md', padding: 'paddingtop', color: 'foreground' })} text-center`}
          >
            1 craft digital solutions that showcase my passion and expertise in
          ...
          <div className="grid grid-cols-3 gap-4 mt-20">
            <div className="mb-10">
              ...
              <div className="flex justify-evenly py-4">
                <div
                  className={`rounded-3xl border-1 py-2 px-4 hover:text-violetgradient hover:border-violetgradient`}
                >
                  Laravel
                </div>
                <div
      ...
      <section className="flex flex-col items-center p-10 border-b-1 pb-32">
        <div className="container flex flex-col">
          ...
          <div
            className={`${title({ size: 'md', padding: 'paddingtop', color: 'foreground' })} text-center`}
          >
            I enjoy solving problems with functional solutions. Here are some
            key skills I've developed over my career.
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-10">
            <div className="flex flex-col border-1 border-foreground-500 rounded-3xl w-full px-5 pt-20 pb-10">
              {/* Icon */}
              <FaLaravel
                className="border-1 border-foreground-500 rounded-xl p-2"
                height={50}
                size={50}
              />
              <div
                className={`${title({ size: 'small', color: 'violet' })} mt-5`}
              >
                Laravel Framework
              </div>
              <div className={`${title({ size: 'extrasmall' })} mt-2`}>
                I have experience developing web applications using the Laravel
                framework, which is known for its simplicity and elegance.
              </div>
            </div>
            <div className="flex flex-col border-1 border-foreground-500 rounded-3xl w-full px-5 pt-20 pb-10">
              {/* Icon */}
              ...
              <div className={`${title({ size: 'extrasmall' })} mt-2`}>
                I have experience building web applications with Next.js, known
            ...
            <div className="flex flex-col border-1 border-foreground-500 rounded-3xl w-full px-5 pt-20 pb-10">
              ...
              <div className={`${title({ size: 'extrasmall' })} mt-2`}>
                I have experience developing backend applications using
                Express.js with TypeScript, known for its robustness and type
                safety
              </div>
            </div>
          </div>
      ...
      <section className="flex flex-col items-center p-10">
        <div className="container grid grid-cols-2 py-10">
          ...
          <div className=" flex py-10 flex-col items-center">
            <Button
              className={` border-1 px-10 py-10 border-gray-700 bg-transparent hover:text-violetgradient hover:border-violetgradient`}
              radius="full"
              size="lg"
            >
              <TfiEmail className="" size={50} />
      ...
      <section className="flex flex-col items-center p-10 border-t-1 border-gray-500">
        <div className="container flex justify-between">
          <div>
            created by{' '}
            <span
              className={`${title({ size: 'extrasmall', color: 'violet' })}`}
            >
              febryan.
            </span>
          </div>
